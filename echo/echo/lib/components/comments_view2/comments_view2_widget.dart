...
import 'comments_view2_model.dart';
export 'comments_view2_model.dart';

class CommentsView2Widget extends StatefulWidget {
  const CommentsView2Widget({
    Key? key,
    required this.postCommentsToView,
  }) : super(key: key);

  final DocumentReference? postCommentsToView;

  @override
  _CommentsView2WidgetState createState() => _CommentsView2WidgetState();
}

class _CommentsView2WidgetState extends State<CommentsView2Widget> {
  late CommentsView2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentsView2Model());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PostsRecord>(
      stream: PostsRecord.getDocument(widget.postCommentsToView!),
                      ...
                      child: StreamBuilder<List<CommentsRecord>>(
                        stream: queryCommentsRecord(
                          queryBuilder: (commentsRecord) => commentsRecord
                              .where(
                                'comment_post',
                                isEqualTo: createNotePostsRecord.reference,
                              )
                  ...
                  Container(
                    ...
                    child: Visibility(
                      visible: valueOrDefault<bool>(
                        createNotePostsRecord.postCommentsEnabled == true,
                        true,
                      ),
                      child: Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  await CommentsRecord.collection
                                      ...
                                      .set(createCommentsRecordData(
                                        ...
                                        commentOriginalMessage:
                                            _model.textController.text,
                                        commentPost: widget.postCommentsToView,
                                      ));
                                  setState(() =>

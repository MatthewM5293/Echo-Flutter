      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ProfileViewWidget(
            userToView: params.getParam(
                'userToView', ParamType.DocumentReference, false, ['Users']),
          ),
        ),
        FFRoute(
          name: 'createPost',
        ...
        FFRoute(
          name: 'ProfileViewCopy',
          path: '/profileDefaultView',
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ProfileViewCopy')
              : ProfileViewCopyWidget(),
        ),
        FFRoute(
          name: 'notif',
          path: '/notif',
          builder: (context, params) => NotifWidget(),
        ),
        FFRoute(
          name: 'EditComments',
          path: '/editComments',
          builder: (context, params) => EditCommentsWidget(
            commentToEdit: params.getParam('commentToEdit',
                ParamType.DocumentReference, false, ['comments']),
          ),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/echo-high-resolution-logo-transparent.png',
